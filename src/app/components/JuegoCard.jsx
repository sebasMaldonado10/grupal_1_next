...
export default function JuegoCard({ juego }) {
  ...
  return (
    <article className="w-[340px] rounded-xl border-4 border-double border-purple-500 text-violet-300 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 p-4 hover:bg-violet-800/50 hover:text-white transition">
