...
export default function Juegos({ juegos }) {
  const { carrito, favoritos, addCarrito, deleteCarrito, addFavorito, deleteFavorito, isMounted } = useAppContext();
            ...
            <div className="flex items-center justify-between p-3">
              ...
              title={enCarrito ? "Quitar del carrito" : "Agregar al carrito"}>
                ...
                {enCarrito ? (
                  ...
                  <svg width="16" height="16" fill="currentColor" className="bi bi-cart-check-fill" viewBox="0 0 16 16">
